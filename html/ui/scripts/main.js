...
var _CiscoCloud$mantl_ui_frontend$Attributes$classes = function (cs) {
...
var Elm = {};
Elm['WebUI'] = Elm['WebUI'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['WebUI'], 'WebUI', typeof _CiscoCloud$mantl_ui_frontend$WebUI$main === 'undefined' ? null : _CiscoCloud$mantl_ui_frontend$WebUI$main);
