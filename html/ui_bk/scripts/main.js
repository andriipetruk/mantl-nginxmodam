...
Elm.Attributes = Elm.Attributes || {};
Elm.Attributes.make = function (_elm) {
   "use strict";
   _elm.Attributes = _elm.Attributes || {};
   if (_elm.Attributes.values) return _elm.Attributes.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var classes = function (cs) {    return $Html$Attributes.classList(A2($List.map,function (m) {    return {ctor: "_Tuple2",_0: m,_1: true};},cs));};
   return _elm.Attributes.values = {_op: _op,classes: classes};
};
Elm.Native.Effects = {};
...
Elm.Route.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var notfound = A2($Html.div,
   _U.list([$Html$Attributes.$class("row")]),
   _U.list([A2($Html.p,_U.list([$Html$Attributes.$class("col-sm-12")]),_U.list([$Html.text("Not found!")]))]));
   var urlFor = function (loc) {
      var url = function () {
         var _p0 = loc;
         switch (_p0.ctor)
         {case "Home": return "/";
            case "HealthOverview": return "/health/";
            default: return A2($Basics._op["++"],"/health/",A2($Basics._op["++"],_p0._0,"/"));}
      }();
      return A2($Basics._op["++"],"#",url);
   };
   var PathChange = function (a) {    return {ctor: "PathChange",_0: a};};
   var init = $Maybe.Nothing;
   var HealthCheck = function (a) {    return {ctor: "HealthCheck",_0: a};};
   var HealthOverview = {ctor: "HealthOverview"};
   var parentFor = function (child) {    var _p1 = child;if (_p1.ctor === "HealthCheck") {    return HealthOverview;} else {    return child;}};
   var navItem = F3(function (model,page,caption) {
      var active = function () {    var _p2 = model;if (_p2.ctor === "Nothing") {    return false;} else {    return _U.eq(parentFor(_p2._0),page);}}();
      return A2($Html.li,
      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "nav-item",_1: true},{ctor: "_Tuple2",_0: "active",_1: active}]))]),
      _U.list([A2($Html.a,_U.list([$Html$Attributes.$class("nav-link"),$Html$Attributes.href(urlFor(page))]),_U.list([$Html.text(caption)]))]));
   });
   var Home = {ctor: "Home"};
   var locFor = function (path) {
      var segments = A2($List.filter,function (seg) {    return !_U.eq(seg,"") && !_U.eq(seg,"#");},A2($String.split,"/",path));
      var _p3 = segments;
      _v3_3: do {
         if (_p3.ctor === "[]") {
               ...
               if (_p3._0 === "health") {
                     if (_p3._1.ctor === "[]") {
                           ...
                           if (_p3._1._1.ctor === "[]") {
                                 return $Maybe.Just(HealthCheck(_p3._1._0));
                              } else {
                                 break _v3_3;
                              }
                        }
   ...
   var update = F2(function (action,model) {    var _p4 = action;return {ctor: "_Tuple2",_0: locFor(_p4._0),_1: $Effects.none};});
...
Elm.Health.make = function (_elm) {
   ...
   if (_elm.Health.values) return _elm.Health.values;
   var _U = Elm.Native.Utils.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var isFocused = F2(function (name,focus) {    var _p0 = focus;if (_p0.ctor === "Nothing") {    return false;} else {    return _U.eq(name,_p0._0);}});
   var hasNotes = function (check) {    return !_U.eq(check.notes,"");};
   var addCheck = F2(function (check,val) {
      var _p1 = val;
      if (_p1.ctor === "Nothing") {
            return $Maybe.Just(_U.list([check]));
         } else {
            return $Maybe.Just(A2($List._op["::"],check,_p1._0));
         }
   });
   var updateCheckDict = F3(function (selector,check,checks) {    return A3($Dict.update,selector(check),addCheck(check),checks);});
   var groupBy = F2(function (selector,checks) {    return A3($List.foldl,updateCheckDict(selector),$Dict.empty,checks);});
   var displayGrouping = function (checks) {
      ...
      function (_p2) {
         ...
         var _p5 = _p3._1;
         var _p4 = _p3._0;
         return _U.eq(_p4,"") ? {ctor: "_Tuple2",_0: "consul",_1: _p5} : {ctor: "_Tuple2",_0: _p4,_1: _p5};
      },
      $Dict.toList(A2(groupBy,function (_) {    return _.serviceName;},checks))));
   };
   var attributes = function (attrs) {
      return A2($Html.dl,
      _U.list([$Html$Attributes.$class("attributes")]),
      A2($List.map,
      function (_p6) {
         var _p7 = _p6;
         return A2($Html.div,
         _U.list([$Html$Attributes.$class("attribute")]),
         _U.list([A2($Html.dt,_U.list([]),_U.list([$Html.text(_p7._0)]))
                 ,A2($Html.dd,_U.list([]),_U.list([A2($Html.code,_U.list([]),_U.list([$Html.text(_p7._1)]))]))]));
      },
      attrs));
   };
   var statusToString = function (status) {
      var _p8 = status;
      if (_p8.ctor === "Other") {
            return A2($Basics._op["++"],"Unknown Status: ",_p8._0);
         } else {
   ...
   var healthDot = F2(function (status,size) {
      return A2($Html.span,_U.list([$Attributes.classes(_U.list(["healthdot",size,statusToClass(status)]))]),_U.list([$Html.text(statusToString(status))]));
   });
   var checkDetail = F2(function (address,check) {
      return A2($Html.div,
      _U.list([$Attributes.classes(_U.list(["check","card","card-block",statusToClass(check.status)]))]),
      _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text(check.name)]))
              ,attributes(_U.list([{ctor: "_Tuple2",_0: "Status",_1: statusToString(check.status)}
              ...
              ,A2($Html.p,
              _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "notes",_1: true}
                                                          ,{ctor: "_Tuple2",_0: "hidden",_1: $Basics.not(A2($Debug.log,"has notes",hasNotes(check)))}]))]),
              _U.list([A2($Html.strong,_U.list([]),_U.list([$Html.text("Notes: ")])),$Html.text(check.notes)]))
              ,A2($Html.p,_U.list([]),_U.list([A2($Html.strong,_U.list([]),_U.list([$Html.text("Output:")]))]))
              ,A2($Html.pre,_U.list([$Html$Attributes.$class("output")]),_U.list([A2($Html.code,_U.list([]),_U.list([$Html.text(check.output)]))]))]));
   });
   var LoadChecks = {ctor: "LoadChecks"};
   var NewChecks = function (a) {    return {ctor: "NewChecks",_0: a};};
   var Model = F3(function (a,b,c) {    return {status: a,checks: b,error: c};});
   var Other = function (a) {    return {ctor: "Other",_0: a};};
   ...
   var worstStatus = function (checks) {
      ...
      A2($List.map,function (_) {    return _.status;},checks))));
   };
   var checkSelector = F4(function (address,name,checks,active) {
      return A2($Html.a,
      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "service",_1: true}
                                                  ,{ctor: "_Tuple2",_0: "card",_1: true}
                                                  ,{ctor: "_Tuple2",_0: "card-block",_1: true}
                                                  ,{ctor: "_Tuple2",_0: statusToClass(worstStatus(checks)),_1: true}
                                                  ,{ctor: "_Tuple2",_0: "active",_1: active}]))
              ,$Html$Attributes.href($Route.urlFor($Route.HealthCheck(name)))]),
      _U.list([$Html.text(name)]));
   });
   var view = F3(function (address,model,focus) {
      var content = function () {
         if ($List.isEmpty(model.checks)) return A2($Html.p,_U.list([$Html$Attributes.$class("col-sm-12")]),_U.list([$Html.text("No Health Checks loaded")]));
         else {
               ...
               var focusedGroup = function () {
                  ...
                  if (_p11.ctor === "Nothing") {
                        ...
                        return A2($Dict.get,_p11._0,groups);
                     }
               }();
               var focusContent = function () {
                  var _p12 = {ctor: "_Tuple2",_0: focus,_1: focusedGroup};
                  if (_p12._0.ctor === "Nothing") {
                        ...
                        if (_p12._1.ctor === "Nothing") {
                              return A2($Html.div,
                              _U.list([]),
                              _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text(A2($Basics._op["++"],"No health checks found for ",_p12._0._0))]))]));
                           } else {
                              var _p13 = _p12._1._0;
                              return A2($Html.div,
                              _U.list([]),
                              _U.list([A2($Html.h1,_U.list([]),_U.list([A2(healthDot,worstStatus(_p13),"large"),$Html.text(_p12._0._0)]))
                                      ,A2($Html.div,_U.list([$Html$Attributes.$class("checks")]),A2($List.map,checkDetail(address),_p13))]));
                           }
                     }
               }();
               return A2($Html.div,
               ...
               _U.list([A2($Html.div,
                       _U.list([$Attributes.classes(_U.list(["row","controls"]))]),
                       _U.list([A2($Html.div,
                       _U.list([$Html$Attributes.$class("col-sm-12")]),
                       _U.list([A2($Html.button,
                       _U.list([$Attributes.classes(_U.list(["btn","btn-sm","btn-secondary"])),A2($Html$Events.onClick,address,LoadChecks)]),
                       _U.list([$Html.text("Reload Health Checks")]))]))]))
                       ,A2($Html.div,
                       _U.list([$Attributes.classes(_U.list(["row","healthchecks"]))]),
                       _U.list([A2($Html.div,
                               _U.list([$Attributes.classes(_U.list(["services","col-md-3"]))]),
                               A2($List.map,
                               function (_p14) {
                                  var _p15 = _p14;
                                  var _p16 = _p15._0;
                                  return A4(checkSelector,address,_p16,_p15._1,A2(isFocused,_p16,focus));
                               },
                               $Dict.toList(groups)))
                               ,A2($Html.div,_U.list([$Html$Attributes.$class("col-md-9")]),_U.list([focusContent]))]))]));
            }
      }();
      return A2($Html.div,_U.list([$Html$Attributes.$class("row")]),_U.list([content]));
   });
   var statusForService = function (name) {
      return function (_p17) {
         return worstStatus(A2($Maybe.withDefault,_U.list([]),A2($Dict.get,name,displayGrouping(function (_) {    return _.checks;}(_p17)))));
      };
   };
   var Passing = {ctor: "Passing"};
   var statusDecoder = A2($Json$Decode.customDecoder,
   $Json$Decode.string,
   function (status) {
      var _p18 = status;
      switch (_p18)
      {case "passing": return $Result.Ok(Passing);
         case "unknown": return $Result.Ok(Unknown);
         case "warning": return $Result.Ok(Warning);
         case "critical": return $Result.Ok(Critical);
         default: return $Result.Ok(Other(status));}
   });
   var Check = F8(function (a,b,c,d,e,f,g,h) {    return {node: a,checkID: b,name: c,status: d,notes: e,output: f,serviceID: g,serviceName: h};});
   var healthCheckDecoder = A9($Json$Decode.object8,
   Check,
   A2($Json$Decode._op[":="],"Node",$Json$Decode.string),
   A2($Json$Decode._op[":="],"CheckID",$Json$Decode.string),
   A2($Json$Decode._op[":="],"Name",$Json$Decode.string),
   A2($Json$Decode._op[":="],"Status",statusDecoder),
   A2($Json$Decode._op[":="],"Notes",$Json$Decode.string),
   A2($Json$Decode._op[":="],"Output",$Json$Decode.string),
   A2($Json$Decode._op[":="],"ServiceID",$Json$Decode.string),
   A2($Json$Decode._op[":="],"ServiceName",$Json$Decode.string));
   var loadHealth = $Effects.task(A2($Task.map,NewChecks,$Task.toMaybe(A2($Http.get,$Json$Decode.list(healthCheckDecoder),"/consul/v1/health/state/any"))));
   var init = {ctor: "_Tuple2",_0: {status: Unknown,checks: _U.list([]),error: $Maybe.Nothing},_1: loadHealth};
   var update = F2(function (action,model) {
      var _p19 = action;
      if (_p19.ctor === "NewChecks") {
            if (_p19._0.ctor === "Nothing") {
                  return {ctor: "_Tuple2",_0: _U.update(model,{error: $Maybe.Just("Could not retrieve health checks")}),_1: $Effects.none};
               } else {
                  var _p20 = _p19._0._0;
                  return {ctor: "_Tuple2",_0: _U.update(model,{checks: _p20,status: worstStatus(_p20),error: $Maybe.Nothing}),_1: $Effects.none};
               }
         } else {
            return {ctor: "_Tuple2",_0: model,_1: loadHealth};
         }
   });
   return _elm.Health.values = {_op: _op
                               ,Check: Check
                               ,Passing: Passing
                               ,Unknown: Unknown
                               ,Warning: Warning
...
Elm.Services.make = function (_elm) {
   "use strict";
   _elm.Services = _elm.Services || {};
   if (_elm.Services.values) return _elm.Services.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Attributes = Elm.Attributes.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var serviceView = F3(function (address,health,service) {
      return A2($Html.div,
      _U.list([$Attributes.id(service.id)]),
      _U.list([$Attributes.classes(_U.list(["col-sm-3","service"]))]),
      _U.list([A2($Html.div,
      _U.list([$Attributes.classes(_U.list(["card","card-block"]))]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("logo")]),_U.list([A2($Html.div,_U.list([$Html$Attributes.$class(service.id)]),_U.list([]))]))
              ,A2($Html.h4,_U.list([$Html$Attributes.$class("card-title")]),_U.list([$Html.text(service.name)]))
              ,A2($Html.a,
              _U.list([$Attributes.classes(_U.list(["btn","btn-block","btn-primary"])),$Html$Attributes.href(service.path)]),
              _U.list([$Html.text("Web UI")]))
              ,A2($Html.a,
              _U.list([$Attributes.classes(_U.list(["btn","btn-block","btn-health",$Health.statusToClass(health)]))
                      ,$Html$Attributes.href($Route.urlFor($Route.HealthCheck(service.check)))]),
              _U.list([$Html.text(A2($Basics._op["++"],"Checks: ",$Health.statusToString(health)))]))]))]));
   });
   var NewServices = function (a) {    return {ctor: "NewServices",_0: a};};
   var LoadServices = {ctor: "LoadServices"};
   var view = F3(function (address,model,health) {
      var content = function () {
         var _p0 = model;
         if (_p0.ctor === "Nothing") {
               return A2($Html.p,_U.list([$Html$Attributes.$class("col-sm-12")]),_U.list([$Html.text("No services loaded")]));
            } else {
               return A2($Html.div,
               _U.list([$Html$Attributes.$class("col-sm-12")]),
               _U.list([A2($Html.div,
                       ...
                       _U.list([$Html$Attributes.$class("col-sm-12")]),
                       _U.list([A2($Html.button,
                       _U.list([$Attributes.classes(_U.list(["btn","btn-sm","btn-secondary"])),A2($Html$Events.onClick,address,LoadServices)]),
                       _U.list([$Html.text("Reload Services")]))]))]))
                       ,A2($Html.div,
                       _U.list([$Attributes.classes(_U.list(["row","services"]))]),
                       A2($List.map,function (s) {    return A3(serviceView,address,A2($Health.statusForService,s.check,health),s);},_p0._0))]));
            }
      }();
      return A2($Html.div,_U.list([$Html$Attributes.$class("row")]),_U.list([content]));
   });
   var Service = F4(function (a,b,c,d) {    return {name: a,id: b,check: c,path: d};});
   var serviceDecoder = A5($Json$Decode.object4,
   Service,
   A2($Json$Decode._op[":="],"name",$Json$Decode.string),
   A2($Json$Decode._op[":="],"id",$Json$Decode.string),
   A2($Json$Decode._op[":="],"check",$Json$Decode.string),
   A2($Json$Decode._op[":="],"path",$Json$Decode.string));
   var loadServices = $Effects.task(A2($Task.map,NewServices,$Task.toMaybe(A2($Http.get,$Json$Decode.list(serviceDecoder),"/_internal/services.json"))));
   var init = {ctor: "_Tuple2",_0: $Maybe.Nothing,_1: loadServices};
   var update = F2(function (action,model) {
      var _p1 = action;
      if (_p1.ctor === "NewServices") {
            return {ctor: "_Tuple2",_0: _p1._0,_1: $Effects.none};
         } else {
            return {ctor: "_Tuple2",_0: model,_1: loadServices};
         }
   });
   return _elm.Services.values = {_op: _op
                                 ,Service: Service
                                 ,init: init
...
Elm.Version.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var version = F2(function (address,model) {
      return A2($Html.div,_U.list([$Html$Attributes.$class("version")]),_U.list([$Html.text(A2($Maybe.withDefault,"No Version",model.current))]));
   });
   var view = version;
   var notification = F2(function (address,model) {
      return model.hasUpdate ? A2($Html.div,
      _U.list([$Attributes.classes(_U.list(["navbar","navbar-attention"]))]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("container")]),
      _U.list([A2($Html.p,_U.list([$Html$Attributes.$class("nav-item")]),_U.list([$Html.text("New version available. Please reload!")]))]))])) : A2($Html.div,
      _U.list([]),
      _U.list([]));
   });
   var update = F2(function (action,model) {
      ...
      if (_p0._0.ctor === "Nothing") {
            ...
            if (_p1.ctor === "Nothing") {
                  return {ctor: "_Tuple2",_0: _U.update(model,{current: $Maybe.Just(_p2)}),_1: $Effects.none};
               } else {
                  return _U.eq(_p1._0,_p2) ? {ctor: "_Tuple2",_0: model,_1: $Effects.none} : {ctor: "_Tuple2"
                                                                                             ,_0: _U.update(model,{current: $Maybe.Just(_p2),hasUpdate: true})
                                                                                             ,_1: $Effects.none};
               }
         }
   });
   var NewVersion = function (a) {    return {ctor: "NewVersion",_0: a};};
   var loadVersion = $Effects.task(A2($Task.map,NewVersion,$Task.toMaybe($Http.getString("signature"))));
   var init = {ctor: "_Tuple2",_0: {current: $Maybe.Nothing,hasUpdate: false},_1: loadVersion};
   var Model = F2(function (a,b) {    return {current: a,hasUpdate: b};});
   return _elm.Version.values = {_op: _op
                                ,Model: Model
                                ,init: init
...
Elm.Mantl = Elm.Mantl || {};
Elm.Mantl.make = function (_elm) {
   "use strict";
   _elm.Mantl = _elm.Mantl || {};
   if (_elm.Mantl.values) return _elm.Mantl.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Attributes = Elm.Attributes.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var _op = {};
   var HealthAction = function (a) {    return {ctor: "HealthAction",_0: a};};
   var VersionAction = function (a) {    return {ctor: "VersionAction",_0: a};};
   var ServicesAction = function (a) {    return {ctor: "ServicesAction",_0: a};};
   var view = F2(function (address,model) {
      var body = function () {
         var _p0 = model.route;
         if (_p0.ctor === "Just") {
               switch (_p0._0.ctor)
               {case "Home": return A3($Services.view,A2($Signal.forwardTo,address,ServicesAction),model.services,model.health);
                  case "HealthOverview": return A3($Health.view,A2($Signal.forwardTo,address,HealthAction),model.health,$Maybe.Nothing);
                  default: return A3($Health.view,A2($Signal.forwardTo,address,HealthAction),model.health,$Maybe.Just(_p0._0._0));}
            } else {
      ...
      _U.list([A2($Version.notification,A2($Signal.forwardTo,address,VersionAction),model.version)
              ,A2($Html.div,
              _U.list([$Attributes.classes(_U.list(["navbar","navbar-inverted"]))]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("container")]),
              _U.list([A2($Html.a,
                      _U.list([$Html$Attributes.$class("navbar-brand"),$Html$Attributes.href($Route.urlFor($Route.Home))]),
                      _U.list([$Html.text("Mantl")]))
                      ,A2($Html.ul,
                      _U.list([$Attributes.classes(_U.list(["nav","navbar-nav"]))]),
                      _U.list([A2(link,$Route.Home,"Home"),A2(link,$Route.HealthOverview,"Health")]))
                      ,A2($Html.div,
                      _U.list([$Attributes.classes(_U.list(["nav","navbar-nav","pull-right"]))]),
                      _U.list([A2($Html.a,
                      _U.list([$Attributes.classes(_U.list(["nav-item","nav-link","health",$Health.statusToClass(model.health.status)]))
                              ,$Html$Attributes.href($Route.urlFor($Route.HealthOverview))]),
                      _U.list([A2($Health.healthDot,model.health.status,"small"),$Html.text($Health.statusToString(model.health.status))]))]))]))]))
              ,A2($Html.div,
              _U.list([$Attributes.classes(_U.list(["container","content"]))]),
              _U.list([body,A2($Version.view,A2($Signal.forwardTo,address,VersionAction),model.version)]))]));
   });
   var RouteAction = function (a) {    return {ctor: "RouteAction",_0: a};};
   var update = F2(function (action,model) {
      var _p1 = action;
      switch (_p1.ctor)
      {case "Refresh": return {ctor: "_Tuple2"
                              ,_0: model
                              ,_1: $Effects.batch(_U.list([A2($Effects.map,VersionAction,$Version.loadVersion)
                                                          ,A2($Effects.map,HealthAction,$Health.loadHealth)]))};
         case "ServicesAction": var _p2 = A2($Services.update,_p1._0,model.services);
           var services = _p2._0;
           var fx = _p2._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{services: services}),_1: A2($Effects.map,ServicesAction,fx)};
         case "RouteAction": var _p3 = A2($Route.update,_p1._0,model.route);
           var route = _p3._0;
           var fx = _p3._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{route: route}),_1: A2($Effects.map,RouteAction,fx)};
         case "VersionAction": var _p4 = A2($Version.update,_p1._0,model.version);
           var version = _p4._0;
           var fx = _p4._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{version: version}),_1: A2($Effects.map,VersionAction,fx)};
         default: var _p5 = A2($Health.update,_p1._0,model.health);
           var health = _p5._0;
           var fx = _p5._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{health: health}),_1: A2($Effects.map,HealthAction,fx)};}
   });
   ...
   var init = function () {
      ...
      var health = _p6._0;
      var hfx = _p6._1;
      var _p7 = $Version.init;
      var version = _p7._0;
      var vfx = _p7._1;
      var _p8 = $Services.init;
      var services = _p8._0;
      var sfx = _p8._1;
      var route = $Route.init;
      return {ctor: "_Tuple2"
             ,_0: {route: route,services: services,version: version,health: health}
             ,_1: $Effects.batch(_U.list([A2($Effects.map,ServicesAction,sfx),A2($Effects.map,VersionAction,vfx),A2($Effects.map,HealthAction,hfx)]))};
   }();
   var Model = F4(function (a,b,c,d) {    return {route: a,services: b,version: c,health: d};});
   return _elm.Mantl.values = {_op: _op
                              ,Model: Model
                              ,init: init
                              ,Refresh: Refresh
...
Elm.WebUI = Elm.WebUI || {};
Elm.WebUI.make = function (_elm) {
   "use strict";
   _elm.WebUI = _elm.WebUI || {};
   if (_elm.WebUI.values) return _elm.WebUI.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var refresh = A2($Signal.map,function (_p0) {    return $Mantl.Refresh;},$Time.every(10 * $Time.second));
   var hash = A2($Signal.map,function (_p1) {    return $Mantl.RouteAction($Route.PathChange(_p1));},$History.hash);
   var app = $StartApp.start({init: $Mantl.init,update: $Mantl.update,view: $Mantl.view,inputs: _U.list([refresh]),inits: _U.list([hash])});
   var main = app.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",app.tasks);
   return _elm.WebUI.values = {_op: _op,app: app,main: main,hash: hash,refresh: refresh};
};
